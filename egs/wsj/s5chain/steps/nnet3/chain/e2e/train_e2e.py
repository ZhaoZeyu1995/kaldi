...
def train(args, run_opts):
    ...
    # Added round() by Zeyu, to avoid float numbers
    egs_left_context = left_context + round(args.frame_subsampling_factor / 2)
    egs_right_context = right_context + round(args.frame_subsampling_factor / 2)
    ...
    # Add round to keep int, by Zeyu
    num_iters = round(((num_archives_to_process * 2)
