...
if [ $stage -le 3 ]; then
  ...
  for datadir in iemo meld mosi; do
  ...
  #steps/online/nnet2/train_diag_ubm.sh --cmd "$train_cmd" --nj 20 \
    #--num-frames 700000 \
...
if [ $stage -le 7 ]; then
  echo "$0: extracting iVectors for iemo meld and mosi data"
  for data in iemo meld mosi; do
