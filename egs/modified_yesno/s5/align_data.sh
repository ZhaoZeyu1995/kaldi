...
for x in train_yyn dev_yyn test_yyn test_sam_yyn test_sam_yyn_noise; do
    steps/align_si.sh --nj 1 data/$x data/lang_test_yyn exp/mono_train_yyn_10 exp/mono_ali_$x
done
for x in train_ynn dev_ynn test_ynn test_sam_ynn test_sam_ynn_noise; do
    steps/align_si.sh --nj 1 data/$x data/lang_test_ynn exp/mono_train_ynn_10 exp/mono_ali_$x
done
